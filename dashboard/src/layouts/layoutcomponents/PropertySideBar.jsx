...
import { MENUITEMS } from "../../common/PropertySidebarData";
...
const PropertySidebar = ({ local_varaiable, ThemeChanger }) => {
    ...
    function setSubmenu(event, targetObject, MENUITEMS = menuitems) {
        ...
        if (
            (window.screen.availWidth <= 992 ||
                theme.datanavlayout != "icon-hover") &&
            (window.screen.availWidth <= 992 || theme.datanavlayout != "menu-hover")
        ) {
            if (!event?.ctrlKey) {
    ...
    function toggleSidemenu(event, targetObject, MENUITEMS = menuitems) {
        ...
        if (
            ...
            const isMenuClickOrIconClick =
                theme.datanavlayout === "menu-click" ||
                theme.datanavlayout === "icon-click";
    ...
    useEffect(() => {
        if (property.length > 0) {
            setSelectedProperty({
                label: property[0].property_name,
                value: property[0],
            });
        }
    }, [property]);
    ...
    const handlereSelect = (option) => {
        if (option?.isLink) {
            window.location.href = "/dashboard/property/create";
        } else {
            setSelectedProperty(option);
            navigator(`/dashboard/property/view/${option?.value?._id}`);
        }
    };
        ...
        <Fragment>
            ...
            >
                ...
                <div className="main-sidebar-header">
                    <Link
                        to={`/dashboard/`}
                        className="header-logo d-flex justify-content-center"
                    >
                        <img
                            src={ALLImages("ypLogoBig")}
                            alt="logo"
                            className="desktop-logo w-75"
                        />
                        <img
                            src={ALLImages("yplogoSmall")}
                            alt="logo"
                            className="toggle-logo w-100"
                        />
                        <img
                            src={ALLImages("ypLogoBig")}
                            alt="logo"
                            className="desktop-dark w-75"
                        />
                        <img
                            src={ALLImages("yplogoSmall")}
                            alt="logo"
                            className="toggle-dark w-100"
                        />
                        <img
                            src={ALLImages("ypLogoBig")}
                            alt="logo"
                            className="desktop-white w-75"
                        />
                        <img
                            src={ALLImages("yplogoSmall")}
                            alt="logo"
                            className="toggle-white w-100"
                        />
                    </Link>
                </div>
                        ...
                        <ul className="main-menu" onClick={() => Sideclick()}>
                            {authUser?.role === "Property Manager" && (
                                <div className="p-2 text-center w-100">
                                    <Select
                                        className="react-select-container rounded-pill"
                                    ...
                                    <Fragment key={Math.random()}>
                                        {
                                            <li
                                                className={`${levelone.menutitle ? "slide__category" : ""
                                                    } ${levelone.type === "link" ? "slide" : ""}${levelone.type === "sub" ? "slide has-sub" : ""
                                                    } 
                                                    ${levelone?.active
                                                        ? "open"
                                                        : ""
                                                ...
                                                {levelone.type === "link" ? (
                                                        ...
                                                        to={
                                                            levelone?.path
                                                                ? levelone?.title === "Analytics"
                                                                    ? `${levelone?.path}/${selectedProperty?.value?._id}`
                                                                    : levelone?.path
                                                                : levelone?.tab &&
                                                                `/dashboard/property/view/${selectedProperty?.value?._id}?tab=${levelone.tab}#`
                                                        }
                                                    ...
                                                    >
                                                        ...
                                                        {localStorage.zanexlayout === "horizontal" ? (
                                                            ...
                                                            <i
                                                                className={`fe ${levelone.icon} side-menu__icon`}
                                                            ></i>
                                                        ) : localStorage.zanexverticalstyles ===
                                                            "doublemenu" ? (
                                                            // If zanexverticalstyles is 'doublemenu', show tooltip
                                                            <div className="custom-tooltip">
                                                                <OverlayTrigger
                                                                    placement={
                                                                        localStorage.zanexrtl ? "left" : "right"
                                                                    }
...
export default connect(mapStateToProps, { ThemeChanger })(PropertySidebar);