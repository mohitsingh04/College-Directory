                  ...
                  <Card.Body className="text-center">
                    <div className="dropdown user-pro-body">
                      <div className="">
                        ...
                        {user?.profile_image ? (
                          <img src={`${import.meta.env.VITE_API_URL}${user?.profile_image}`} alt="Profile Image Preview" className="avatar avatar-xl rounded-circle mx-auto text-center" />
                        ) : (
                      ...
                      <div className="user-info mg-t-20">
                        <h6 className="fw-semibold mt-2 mb-0">{user?.name}</h6>
                        <span className="mb-0 text-muted fs-12">{user?.role}</span>
                      </div>
                    </div>
                  </Card.Body>
